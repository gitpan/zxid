/* c/zx-exca-enc.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_LEN_SO_exca_InclusiveNamespaces) */
...
int zx_LEN_SO_exca_InclusiveNamespaces(struct zx_ctx* c, struct zx_exca_InclusiveNamespaces_s* x )
{
  ...
  int len = sizeof("<exca:InclusiveNamespaces")-1 + 1 + sizeof("</exca:InclusiveNamespaces>")-1;
  if (c->inc_ns_len)
...
/* FUNC(zx_LEN_WO_exca_InclusiveNamespaces) */
...
int zx_LEN_WO_exca_InclusiveNamespaces(struct zx_ctx* c, struct zx_exca_InclusiveNamespaces_s* x )
{
  ...
  struct zx_elem_s* se MAYBE_UNUSED;
#if 1 /* NORMALMODE */
  int len = 1 + sizeof("InclusiveNamespaces")-1 + 1 + 2 + sizeof("InclusiveNamespaces")-1 + 1;
...
/* FUNC(zx_ENC_SO_exca_InclusiveNamespaces) */
...
#if 1 /* NORMALMODE */
  ZX_OUT_CLOSE_TAG(p, "</exca:InclusiveNamespaces>");
  zx_pop_seen(pop_seen);
#else
  /* root node has no end tag either */
#endif
  ENC_LEN_DEBUG(x, "exca:InclusiveNamespaces", p-enc_base);
  return p;
}

/* FUNC(zx_ENC_WO_exca_InclusiveNamespaces) */
...
/* FUNC(zx_EASY_ENC_SO_exca_InclusiveNamespaces) */
...
struct zx_str* zx_EASY_ENC_SO_exca_InclusiveNamespaces(struct zx_ctx* c, struct zx_exca_InclusiveNamespaces_s* x )
{
  ...
  len = zx_LEN_SO_exca_InclusiveNamespaces(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_SO_exca_InclusiveNamespaces(c, x, buf ), buf, len);
}

/* FUNC(zx_EASY_ENC_WO_exca_InclusiveNamespaces) */
...
struct zx_str* zx_EASY_ENC_WO_exca_InclusiveNamespaces(struct zx_ctx* c, struct zx_exca_InclusiveNamespaces_s* x )
{
  ...
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_WO_exca_InclusiveNamespaces(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_WO_exca_InclusiveNamespaces(c, x, buf ), buf, len);
}

/* c/zx-sa-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_sa_SubjectLocality_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sa_SubjectLocality(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_sa_Action_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sa_Action(c, ns);
            el->g.n = &x->Action->gg.g;
            x->Action = (struct zx_sa_Action_s*)el;
            break;
          case zx_sa_Evidence_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sa_Evidence(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_sa_BaseID_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sa_BaseID(c, ns);
          ...
          case zx_sa_SubjectConfirmation_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sa_SubjectConfirmation(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_sa_SubjectConfirmationData_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sa_SubjectConfirmationData(c, ns);

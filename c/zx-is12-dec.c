/* c/zx-is12-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_is12_Help_ELEM:
            el = (struct zx_elem_s*)zx_DEC_is12_Help(c, ns);
            el->g.n = &x->Help->gg.g;
...
/* FUNC(zx_DEC_is12_EncryptedResourceID) */
...
/* FUNC(zx_DEC_is12_InteractionRequest) */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_is12_Inquiry_ELEM:
            el = (struct zx_elem_s*)zx_DEC_is12_Inquiry(c, ns);
...
/* FUNC(zx_DEC_is12_InteractionResponse) */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_is12_Status_ELEM:
            el = (struct zx_elem_s*)zx_DEC_is12_Status(c, ns);
            el->g.n = &x->Status->gg.g;
            x->Status = (struct zx_is12_Status_s*)el;
            break;
          case zx_is12_InteractionStatement_ELEM:
            el = (struct zx_elem_s*)zx_DEC_is12_InteractionStatement(c, ns);
          ...
          case zx_is12_Parameter_ELEM:
            el = (struct zx_elem_s*)zx_DEC_is12_Parameter(c, ns);
...
/* FUNC(zx_DEC_is12_InteractionService) */
...
/* FUNC(zx_DEC_is12_InteractionStatement) */
...
/* FUNC(zx_DEC_is12_RedirectRequest) */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_is12_Item_ELEM:
            el = (struct zx_elem_s*)zx_DEC_is12_Item(c, ns);
            el->g.n = &x->Item->gg.g;
...
/* FUNC(zx_DEC_is12_UserInteraction) */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_is12_InteractionService_ELEM:
            el = (struct zx_elem_s*)zx_DEC_is12_InteractionService(c, ns);

...
*zx_check_elem_order = *Net::SAMLc::zx_check_elem_order;
...
*zxlog_debug_xml_blob = *Net::SAMLc::zxlog_debug_xml_blob;
...
*mk_usr_a7n_to_sp = *Net::SAMLc::zxid_mk_usr_a7n_to_sp;
*check_fed = *Net::SAMLc::zxid_check_fed;
*add_fed_tok2epr = *Net::SAMLc::zxid_add_fed_tok2epr;
...
*mk_sa_attribute = *Net::SAMLc::zxid_mk_sa_attribute;
...
*timestamp_chk = *Net::SAMLc::zxid_timestamp_chk;

/* c/zx-cdm-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
struct zx_cdm_ADR_s* zx_DEC_cdm_ADR(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    case zx_cb_id_ATTR:
      ...
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_cb_modificationTime_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->modificationTime->g;
      x->modificationTime = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cdm_POBOX_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_POBOX(c, ns);
            el->g.n = &x->POBOX->gg.g;
            x->POBOX = (struct zx_cdm_POBOX_s*)el;
            break;
          case zx_cdm_EXTADR_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_EXTADR(c, ns);
            el->g.n = &x->EXTADR->gg.g;
            x->EXTADR = (struct zx_cdm_EXTADR_s*)el;
            break;
          case zx_cdm_STREET_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_STREET(c, ns);
            el->g.n = &x->STREET->gg.g;
            x->STREET = (struct zx_cdm_STREET_s*)el;
            break;
          case zx_cdm_LOCALITY_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_LOCALITY(c, ns);
            el->g.n = &x->LOCALITY->gg.g;
            x->LOCALITY = (struct zx_cdm_LOCALITY_s*)el;
            break;
          case zx_cdm_REGION_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_REGION(c, ns);
            el->g.n = &x->REGION->gg.g;
            x->REGION = (struct zx_cdm_REGION_s*)el;
            break;
          case zx_cdm_PCODE_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_PCODE(c, ns);
            el->g.n = &x->PCODE->gg.g;
            x->PCODE = (struct zx_cdm_PCODE_s*)el;
            break;
          case zx_cdm_CTRY_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_CTRY(c, ns);
            el->g.n = &x->CTRY->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_vCard_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_vCard(c, ns);
            el->g.n = &x->vCard->gg.g;
            x->vCard = (struct zx_cdm_vCard_s*)el;
            break;
          case zx_cdm_EXTVAL_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_EXTVAL(c, ns);
            el->g.n = &x->EXTVAL->gg.g;
...
struct zx_cdm_BDAY_s* zx_DEC_cdm_BDAY(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    case zx_cb_ACC_ATTR:
      ...
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_cb_ACCTime_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->ACCTime->g;
      x->ACCTime = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_cb_modifier_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->modifier->g;
      x->modifier = ss;
      ZX_ATTR_DEC_EXT(ss);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cdm_URI_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_URI(c, ns);
            el->g.n = &x->URI->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_KEYWORD_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_KEYWORD(c, ns);
            el->g.n = &x->KEYWORD->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cdm_USERID_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_USERID(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_LAT_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_LAT(c, ns);
            el->g.n = &x->LAT->gg.g;
            x->LAT = (struct zx_cdm_LAT_s*)el;
            break;
          case zx_cdm_LON_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_LON(c, ns);
            el->g.n = &x->LON->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_TYPE_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_TYPE(c, ns);
            el->g.n = &x->TYPE->gg.g;
            x->TYPE = (struct zx_cdm_TYPE_s*)el;
            break;
          case zx_cdm_CRED_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_CRED(c, ns);
            el->g.n = &x->CRED->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cdm_LINE_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_LINE(c, ns);
            el->g.n = &x->LINE->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cdm_BINVAL_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_BINVAL(c, ns);
            el->g.n = &x->BINVAL->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_FAMILY_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_FAMILY(c, ns);
            el->g.n = &x->FAMILY->gg.g;
            x->FAMILY = (struct zx_cdm_FAMILY_s*)el;
            break;
          case zx_cdm_GIVEN_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_GIVEN(c, ns);
            el->g.n = &x->GIVEN->gg.g;
            x->GIVEN = (struct zx_cdm_GIVEN_s*)el;
            break;
          case zx_cdm_MIDDLE_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_MIDDLE(c, ns);
            el->g.n = &x->MIDDLE->gg.g;
            x->MIDDLE = (struct zx_cdm_MIDDLE_s*)el;
            break;
          case zx_cdm_PREFIX_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_PREFIX(c, ns);
            el->g.n = &x->PREFIX->gg.g;
            x->PREFIX = (struct zx_cdm_PREFIX_s*)el;
            break;
          case zx_cdm_SUFFIX_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_SUFFIX(c, ns);
            el->g.n = &x->SUFFIX->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_ORGNAME_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_ORGNAME(c, ns);
            el->g.n = &x->ORGNAME->gg.g;
            x->ORGNAME = (struct zx_cdm_ORGNAME_s*)el;
            break;
          case zx_cdm_ORGUNIT_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_ORGUNIT(c, ns);
            el->g.n = &x->ORGUNIT->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_PHONETIC_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_PHONETIC(c, ns);
            el->g.n = &x->PHONETIC->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cdm_NUMBER_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_NUMBER(c, ns);
            el->g.n = &x->NUMBER->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cdm_VERSION_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cdm_VERSION(c, ns);
            el->g.n = &x->VERSION_is_Perl_MakeMaker_gobbled->gg.g;

...
struct zx_root_s* zx_DEEP_CLONE_root(struct zx_ctx* c, struct zx_root_s* x, int dup_strs)
{
  ...
  }
  {
      ...
      for (enn = 0, e = x->e_Envelope; e; e = (struct zx_e_Envelope_s*)e->gg.g.n) {
  ...
  {
      struct zx_dise_Envelope_s* e;
      struct zx_dise_Envelope_s* en;
      struct zx_dise_Envelope_s* enn;
      for (enn = 0, e = x->dise_Envelope; e; e = (struct zx_dise_Envelope_s*)e->gg.g.n) {
	  en = zx_DEEP_CLONE_dise_Envelope(c, e, dup_strs);
	  if (!enn)
	      x->dise_Envelope = en;
	  else
	      enn->gg.g.n = &en->gg.g;
...
void zx_FREE_root(struct zx_ctx* c, struct zx_root_s* x, int free_strs)
{
  ...
  }
  {
	  ...
	  en = (struct zx_dise_Envelope_s*)e->gg.g.n;
	  zx_FREE_dise_Envelope(c, e, free_strs);
      }
  }
...
int zx_WALK_SO_root(struct zx_ctx* c, struct zx_root_s* x, void* ctx, int (*callback)(struct zx_node_s* node, void* ctx))
{
  ...
  }
  {
      struct zx_dise_Envelope_s* e;
      for (e = x->dise_Envelope; e; e = (struct zx_dise_Envelope_s*)e->gg.g.n) {
	  ret = zx_WALK_SO_dise_Envelope(c, e, ctx, callback);
	  if (ret)
	      return ret;
      }
  }

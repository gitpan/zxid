...
Net::WSF::Raw - Perl extension for using ID-WSF encoders and decoders
...
The above synopsis is just a tip of the iceberg. Net::WSF::Raw
is part of a bigger project called ZXID. The code for the
Net::WSF::Raw module was automagically generated from schema grammar

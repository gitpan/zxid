/* c/zx-wst-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_wst_RequestSecurityTokenResponse_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_RequestSecurityTokenResponse(c, ns);
            el->g.n = &x->RequestSecurityTokenResponse->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_wsu_Created_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wsu_Created(c, ns);
            el->g.n = &x->Created->gg.g;
            x->Created = (struct zx_wsu_Created_s*)el;
            break;
          case zx_wsu_Expires_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wsu_Expires(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_wst_Primary_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_Primary(c, ns);
            el->g.n = &x->Primary->gg.g;
            x->Primary = (struct zx_wst_Primary_s*)el;
            break;
          case zx_wst_Participant_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_Participant(c, ns);
            el->g.n = &x->Participant->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_wst_TokenType_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->TokenType->g;
            x->TokenType = el;
            break;
          case zx_wst_RequestType_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->RequestType->g;
            x->RequestType = el;
            break;
          ...
          case zx_wst_EncryptWith_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->EncryptWith->g;
            x->EncryptWith = el;
            break;
          case zx_wst_DelegateTo_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_DelegateTo(c, ns);
            el->g.n = &x->DelegateTo->gg.g;
            x->DelegateTo = (struct zx_wst_DelegateTo_s*)el;
            break;
          case zx_wst_Forwardable_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->Forwardable->g;
            x->Forwardable = el;
            break;
          case zx_wst_Delegatable_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->Delegatable->g;
            x->Delegatable = el;
            break;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_wst_RequestSecurityToken_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_RequestSecurityToken(c, ns);
            el->g.n = &x->RequestSecurityToken->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_wst_RequestedSecurityToken_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_RequestedSecurityToken(c, ns);
            el->g.n = &x->RequestedSecurityToken->gg.g;
          ...
          case zx_wst_RequestedAttachedReference_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_RequestedAttachedReference(c, ns);
            el->g.n = &x->RequestedAttachedReference->gg.g;
            x->RequestedAttachedReference = (struct zx_wst_RequestedAttachedReference_s*)el;
            break;
          case zx_wst_RequestedUnattachedReference_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_RequestedUnattachedReference(c, ns);
            el->g.n = &x->RequestedUnattachedReference->gg.g;
            x->RequestedUnattachedReference = (struct zx_wst_RequestedUnattachedReference_s*)el;
            break;
          case zx_wst_RequestedProofToken_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_RequestedProofToken(c, ns);
            el->g.n = &x->RequestedProofToken->gg.g;
          ...
          case zx_wst_Status_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_Status(c, ns);
          ...
          case zx_wst_Authenticator_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wst_Authenticator(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_wsse_SecurityTokenReference_ELEM:
            el = (struct zx_elem_s*)zx_DEC_wsse_SecurityTokenReference(c, ns);
            el->g.n = &x->SecurityTokenReference->gg.g;

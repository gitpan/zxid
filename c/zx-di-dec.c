/* c/zx-di-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_di_Options_ELEM:
            el = (struct zx_elem_s*)zx_DEC_di_Options(c, ns);
          ...
          case zx_di_Framework_ELEM:
            el = (struct zx_elem_s*)zx_DEC_di_Framework(c, ns);
            el->g.n = &x->Framework->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_di_EndpointContext_ELEM:
            el = (struct zx_elem_s*)zx_DEC_di_EndpointContext(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_di_ServiceContext_ELEM:
            el = (struct zx_elem_s*)zx_DEC_di_ServiceContext(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_di_SvcMD_ELEM:
            el = (struct zx_elem_s*)zx_DEC_di_SvcMD(c, ns);
            el->g.n = &x->SvcMD->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_di_Keys_ELEM:
            el = (struct zx_elem_s*)zx_DEC_di_Keys(c, ns);
            el->g.n = &x->Keys->gg.g;

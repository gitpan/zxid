/* c/zx-exca-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_DEC_exca_InclusiveNamespaces) */
...
struct zx_exca_InclusiveNamespaces_s* zx_DEC_exca_InclusiveNamespaces(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    switch (tok) {
    case zx_PrefixList_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->PrefixList->g;
      x->PrefixList = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;

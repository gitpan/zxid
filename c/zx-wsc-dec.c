/* c/zx-wsc-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_DEC_wsc_DerivedKeyToken) */
...
/* Called by: */
struct zx_wsc_DerivedKeyToken_s* zx_DEC_wsc_DerivedKeyToken(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
...
/* Called by: */
struct zx_wsc_Properties_s* zx_DEC_wsc_Properties(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
  struct zx_elem_s* iternode;
  struct zx_elem_s* el;
...
/* FUNC(zx_DEC_wsc_SecurityContextToken) */
...
/* Called by: */
struct zx_wsc_SecurityContextToken_s* zx_DEC_wsc_SecurityContextToken(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
  struct zx_elem_s* iternode;
  struct zx_elem_s* el;

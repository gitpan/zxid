/* c/zx-xaspcd1-enc.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_LEN_SO_xaspcd1_XACMLAuthzDecisionQuery) */
...
int zx_LEN_SO_xaspcd1_XACMLAuthzDecisionQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x )
{
  ...
  int len = sizeof("<xaspcd1:XACMLAuthzDecisionQuery")-1 + 1 + sizeof("</xaspcd1:XACMLAuthzDecisionQuery>")-1;
  if (c->inc_ns_len)
...
/* FUNC(zx_LEN_WO_xaspcd1_XACMLAuthzDecisionQuery) */
...
/* Called by: */
int zx_LEN_WO_xaspcd1_XACMLAuthzDecisionQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x )
{
  struct zx_ns_s* pop_seen = 0;
  struct zx_elem_s* se MAYBE_UNUSED;
#if 1 /* NORMALMODE */
...
/* FUNC(zx_ENC_SO_xaspcd1_XACMLAuthzDecisionQuery) */
...
#if 1 /* NORMALMODE */
  ZX_OUT_CLOSE_TAG(p, "</xaspcd1:XACMLAuthzDecisionQuery>");
  zx_pop_seen(pop_seen);
#else
  /* root node has no end tag either */
#endif
  ENC_LEN_DEBUG(x, "xaspcd1:XACMLAuthzDecisionQuery", p-enc_base);
  return p;
}

/* FUNC(zx_ENC_WO_xaspcd1_XACMLAuthzDecisionQuery) */
...
/* FUNC(zx_EASY_ENC_SO_xaspcd1_XACMLAuthzDecisionQuery) */
...
struct zx_str* zx_EASY_ENC_SO_xaspcd1_XACMLAuthzDecisionQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x )
{
  ...
  len = zx_LEN_SO_xaspcd1_XACMLAuthzDecisionQuery(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_SO_xaspcd1_XACMLAuthzDecisionQuery(c, x, buf ), buf, len);
}

/* FUNC(zx_EASY_ENC_WO_xaspcd1_XACMLAuthzDecisionQuery) */

/* Called by: */
struct zx_str* zx_EASY_ENC_WO_xaspcd1_XACMLAuthzDecisionQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x )
{
  int len;
  char* buf;
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_WO_xaspcd1_XACMLAuthzDecisionQuery(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_WO_xaspcd1_XACMLAuthzDecisionQuery(c, x, buf ), buf, len);
}
...
/* FUNC(zx_LEN_SO_xaspcd1_XACMLPolicyQuery) */
...
#if 1 /* NORMALMODE */
  /* *** in simple_elem case should output ns prefix from ns node. */
  int len = sizeof("<xaspcd1:XACMLPolicyQuery")-1 + 1 + sizeof("</xaspcd1:XACMLPolicyQuery>")-1;
  if (c->inc_ns_len)
    len += zx_len_inc_ns(c, &pop_seen);
  len += zx_len_xmlns_if_not_seen(c, zx_ns_tab+zx_xmlns_ix_xaspcd1, &pop_seen);
...
/* FUNC(zx_LEN_WO_xaspcd1_XACMLPolicyQuery) */
...
/* Called by: */
int zx_LEN_WO_xaspcd1_XACMLPolicyQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLPolicyQuery_s* x )
{
  struct zx_ns_s* pop_seen = 0;
  struct zx_elem_s* se MAYBE_UNUSED;
#if 1 /* NORMALMODE */
...
/* FUNC(zx_ENC_SO_xaspcd1_XACMLPolicyQuery) */
...
#if 1 /* NORMALMODE */
  ZX_OUT_CLOSE_TAG(p, "</xaspcd1:XACMLPolicyQuery>");
  zx_pop_seen(pop_seen);
#else
  /* root node has no end tag either */
#endif
  ENC_LEN_DEBUG(x, "xaspcd1:XACMLPolicyQuery", p-enc_base);
  return p;
}

/* FUNC(zx_ENC_WO_xaspcd1_XACMLPolicyQuery) */
...
/* FUNC(zx_EASY_ENC_SO_xaspcd1_XACMLPolicyQuery) */
...
struct zx_str* zx_EASY_ENC_SO_xaspcd1_XACMLPolicyQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLPolicyQuery_s* x )
{
  ...
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_SO_xaspcd1_XACMLPolicyQuery(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_SO_xaspcd1_XACMLPolicyQuery(c, x, buf ), buf, len);
}

/* FUNC(zx_EASY_ENC_WO_xaspcd1_XACMLPolicyQuery) */

/* Called by: */
struct zx_str* zx_EASY_ENC_WO_xaspcd1_XACMLPolicyQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLPolicyQuery_s* x )
{
  int len;
  char* buf;
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_WO_xaspcd1_XACMLPolicyQuery(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_WO_xaspcd1_XACMLPolicyQuery(c, x, buf ), buf, len);
}




/* EOF -- c/zx-xaspcd1-enc.c */

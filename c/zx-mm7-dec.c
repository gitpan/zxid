/* c/zx-mm7-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_mm7_RFC2822Address_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_RFC2822Address(c, ns);
            el->g.n = &x->RFC2822Address->gg.g;
            x->RFC2822Address = (struct zx_mm7_RFC2822Address_s*)el;
            break;
          case zx_mm7_Number_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Number(c, ns);
            el->g.n = &x->Number->gg.g;
            x->Number = (struct zx_mm7_Number_s*)el;
            break;
          case zx_mm7_ShortCode_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_ShortCode(c, ns);
            el->g.n = &x->ShortCode->gg.g;
            x->ShortCode = (struct zx_mm7_ShortCode_s*)el;
            break;
          case zx_mm7_Extension_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Extension(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_mm7_MM7Version_ELEM:
            ...
            el->g.n = &x->MM7Version->g;
            x->MM7Version = el;
            break;
          case zx_mm7_SenderIdentification_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_SenderIdentification(c, ns);
            el->g.n = &x->SenderIdentification->gg.g;
          ...
          case zx_mm7_MessageID_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->MessageID->g;
            x->MessageID = el;
            break;
          case zx_mm7_Recipients_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Recipients(c, ns);
            el->g.n = &x->Recipients->gg.g;
          ...
          case zx_mm7_ReplyApplicID_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->ReplyApplicID->g;
            x->ReplyApplicID = el;
            break;
          case zx_mm7_AuxApplicInfo_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->AuxApplicInfo->g;
            x->AuxApplicInfo = el;
            break;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_mm7_Status_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Status(c, ns);
...
struct zx_mm7_Content_s* zx_DEC_mm7_Content(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    tok = zx_attr_lookup(c, name, data-2, &ns);
    switch (tok) {
    case zx_allowAdaptations_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->allowAdaptations->g;
      x->allowAdaptations = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_href_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_mm7_Sender_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Sender(c, ns);
          ...
          case zx_mm7_UACapabilities_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_UACapabilities(c, ns);
            el->g.n = &x->UACapabilities->gg.g;
            x->UACapabilities = (struct zx_mm7_UACapabilities_s*)el;
            break;
          case zx_mm7_Content_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Content(c, ns);
            el->g.n = &x->Content->gg.g;
            x->Content = (struct zx_mm7_Content_s*)el;
            break;
          case zx_mm7_AdditionalInformation_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_AdditionalInformation(c, ns);
            el->g.n = &x->AdditionalInformation->gg.g;
            x->AdditionalInformation = (struct zx_mm7_AdditionalInformation_s*)el;
            break;
          case zx_mm7_MessageExtraData_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_MessageExtraData(c, ns);
            el->g.n = &x->MessageExtraData->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_mm7_ServiceCode_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_ServiceCode(c, ns);
            el->g.n = &x->ServiceCode->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_mm7_Recipient_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Recipient(c, ns);
          ...
          case zx_mm7_MMStatusExtension_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->MMStatusExtension->g;
            x->MMStatusExtension = el;
            break;
          case zx_mm7_StatusText_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->StatusText->g;
            x->StatusText = el;
            break;
          case zx_mm7_ApplicID_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_mm7_IdentityAddressingToken_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_IdentityAddressingToken(c, ns);
            el->g.n = &x->IdentityAddressingToken->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_mm7_element_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_element(c, ns);
            el->g.n = &x->element->gg.g;
...
struct zx_mm7_Number_s* zx_DEC_mm7_Number(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    tok = zx_attr_lookup(c, name, data-2, &ns);
    switch (tok) {
    case zx_addressCoding_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->addressCoding->g;
      x->addressCoding = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_displayOnly_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->displayOnly->g;
      x->displayOnly = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_id_ATTR:
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_mm7_UserAgent_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_UserAgent(c, ns);
            el->g.n = &x->UserAgent->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_mm7_DateTime_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_DateTime(c, ns);
            el->g.n = &x->DateTime->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_mm7_Details_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Details(c, ns);
...
next_attr:
  ...
  next_elem:
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_mm7_To_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_To(c, ns);
            el->g.n = &x->To->gg.g;
            x->To = (struct zx_mm7_To_s*)el;
            break;
          case zx_mm7_Cc_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Cc(c, ns);
            el->g.n = &x->Cc->gg.g;
            x->Cc = (struct zx_mm7_Cc_s*)el;
            break;
          case zx_mm7_Bcc_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_Bcc(c, ns);
            el->g.n = &x->Bcc->gg.g;
...
struct zx_mm7_ReplyCharging_s* zx_DEC_mm7_ReplyCharging(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    tok = zx_attr_lookup(c, name, data-2, &ns);
    switch (tok) {
    case zx_replyChargingSize_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->replyChargingSize->g;
      x->replyChargingSize = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_replyDeadline_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->replyDeadline->g;
      x->replyDeadline = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_mm7_SenderAddress_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_SenderAddress(c, ns);
            el->g.n = &x->SenderAddress->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_mm7_PreferredChannels_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_PreferredChannels(c, ns);
            el->g.n = &x->PreferredChannels->gg.g;
          ...
          case zx_mm7_ReplyCharging_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_ReplyCharging(c, ns);
            el->g.n = &x->ReplyCharging->gg.g;
          ...
          case zx_mm7_ExpiryDate_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->ExpiryDate->g;
            x->ExpiryDate = el;
            break;
          case zx_mm7_DeliveryReport_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->DeliveryReport->g;
            x->DeliveryReport = el;
            break;
          case zx_mm7_ReadReply_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
          ...
          case zx_mm7_ChargedParty_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->ChargedParty->g;
            x->ChargedParty = el;
            break;
          case zx_mm7_ChargedPartyID_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->ChargedPartyID->g;
            x->ChargedPartyID = el;
            break;
          case zx_mm7_ThirdPartyPayer_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_ThirdPartyPayer(c, ns);
            el->g.n = &x->ThirdPartyPayer->gg.g;
          ...
          case zx_mm7_DeliveryCondition_ELEM:
            el = (struct zx_elem_s*)zx_DEC_mm7_DeliveryCondition(c, ns);
            el->g.n = &x->DeliveryCondition->gg.g;
...
struct zx_mm7_TransactionID_s* zx_DEC_mm7_TransactionID(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    case zx_e_actor_ATTR:
      ...
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_e_encodingStyle_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->encodingStyle->g;
      x->encodingStyle = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;

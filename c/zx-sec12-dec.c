/* c/zx-sec12-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_sec12_ProxySubject_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sec12_ProxySubject(c, ns);
            el->g.n = &x->ProxySubject->gg.g;
            x->ProxySubject = (struct zx_sec12_ProxySubject_s*)el;
            break;
          case zx_sec12_SessionContext_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sec12_SessionContext(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_sec12_SessionSubject_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sec12_SessionSubject(c, ns);
            el->g.n = &x->SessionSubject->gg.g;

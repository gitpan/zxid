/* c/zx-cb-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
struct zx_cb_By_s* zx_DEC_cb_By(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    switch (tok) {
    case zx_cb_sortAlg_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->sortAlg->g;
      x->sortAlg = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_cb_sortWeight_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->sortWeight->g;
      x->sortWeight = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cb_NewData_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_NewData(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cb_Status_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_Status(c, ns);
            el->g.n = &x->Status->gg.g;
            x->Status = (struct zx_cb_Status_s*)el;
            break;
          case zx_cb_ItemData_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_ItemData(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cb_DeleteItem_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_DeleteItem(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cb_Modification_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_Modification(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_cb_Notification_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_Notification(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cb_Credential_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_Credential(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cb_QueryItem_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_QueryItem(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cb_Data_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_Data(c, ns);
            el->g.n = &x->Data->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_cb_UsageType_ELEM:
            el = (struct zx_elem_s*)zx_DEC_cb_UsageType(c, ns);
            el->g.n = &x->UsageType->gg.g;

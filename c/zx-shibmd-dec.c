/* c/zx-shibmd-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_DEC_shibmd_KeyAuthority) */
...
struct zx_shibmd_KeyAuthority_s* zx_DEC_shibmd_KeyAuthority(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    switch (tok) {
    case zx_VerifyDepth_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->VerifyDepth->g;
      x->VerifyDepth = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;

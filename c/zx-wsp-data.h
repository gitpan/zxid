/* c/zx-wsp-data.h - WARNING: This header was automatically generated. DO NOT EDIT!
 * $Id$ */
...
#endif
/* -------------------------- wsp_AppliesTo -------------------------- */
/* refby( zx_wsp_PolicyAttachment_s zx_wst_RequestSecurityToken_s zx_wst_RequestSecurityTokenResponse_s ) */
...
#endif
/* -------------------------- wsp_Policy -------------------------- */
/* refby( zx_wsp_PolicyAttachment_s zx_wst_RequestSecurityToken_s zx_wsp_Policy_s zx_wst_RequestSecurityTokenResponse_s zx_wsp_All_s zx_wsp_ExactlyOne_s ) */
...
#ifdef ZX_ENA_GETPUT
struct zx_str* zx_wsp_Policy_GET_Name(struct zx_wsp_Policy_s* x);
struct zx_str* zx_wsp_Policy_GET_Id(struct zx_wsp_Policy_s* x);
...
void zx_wsp_Policy_PUT_Name(struct zx_wsp_Policy_s* x, struct zx_str* y);
void zx_wsp_Policy_PUT_Id(struct zx_wsp_Policy_s* x, struct zx_str* y);

...
Net::SAML::Raw - Perl extension for using SAML encoders and decoders
...
The above synopsis is just a tip of the iceberg. Net::SAML::Raw
is part of a bigger project called ZXID. The code for the
Net::SAML::Raw module was automagically generated from schema grammar

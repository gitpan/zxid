/* c/zx-xasacd1-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_DEC_xasacd1_ReferencedPolicies) */
...
/* Called by: */
struct zx_xasacd1_ReferencedPolicies_s* zx_DEC_xasacd1_ReferencedPolicies(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
...
/* FUNC(zx_DEC_xasacd1_XACMLAuthzDecisionStatement) */
...
/* Called by: */
struct zx_xasacd1_XACMLAuthzDecisionStatement_s* zx_DEC_xasacd1_XACMLAuthzDecisionStatement(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
  struct zx_elem_s* iternode;
  struct zx_elem_s* el;
...
/* FUNC(zx_DEC_xasacd1_XACMLPolicyStatement) */
...
/* Called by: */
struct zx_xasacd1_XACMLPolicyStatement_s* zx_DEC_xasacd1_XACMLPolicyStatement(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
  struct zx_elem_s* iternode;
  struct zx_elem_s* el;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_xasacd1_ReferencedPolicies_ELEM:
            el = (struct zx_elem_s*)zx_DEC_xasacd1_ReferencedPolicies(c, ns);
            el->g.n = &x->ReferencedPolicies->gg.g;
            x->ReferencedPolicies = (struct zx_xasacd1_ReferencedPolicies_s*)el;
            break;

/* c/zx-dp-enc.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
int zx_LEN_SO_dp_Request(struct zx_ctx* c, struct zx_dp_Request_s* x )
{
  ...
  len += zx_len_xmlns_if_not_seen(c, zx_ns_tab+zx_xmlns_ix_dp, &pop_seen);
...
char* zx_ENC_SO_dp_Request(struct zx_ctx* c, struct zx_dp_Request_s* x, char* p )
{
  ...
  p = zx_enc_xmlns_if_not_seen(c, p, zx_ns_tab+zx_xmlns_ix_dp, &pop_seen);
...
/* FUNC(zx_EASY_ENC_WO_dp_Request) */
...
struct zx_str* zx_EASY_ENC_WO_dp_Request(struct zx_ctx* c, struct zx_dp_Request_s* x )
{
  ...
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_WO_dp_Request(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_WO_dp_Request(c, x, buf ), buf, len);
}
...
/* FUNC(zx_EASY_ENC_WO_dp_Response) */
...
struct zx_str* zx_EASY_ENC_WO_dp_Response(struct zx_ctx* c, struct zx_dp_Response_s* x )
{
  ...
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_WO_dp_Response(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_WO_dp_Response(c, x, buf ), buf, len);
}

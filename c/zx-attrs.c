...
#define TOTAL_KEYWORDS 350
#define MIN_WORD_LENGTH 2
#define MAX_WORD_LENGTH 30
#define MIN_HASH_VALUE 8
#define MAX_HASH_VALUE 914
/* maximum key range = 907, duplicates = 20 */
  ...
  static const unsigned short asso_values[] =
    {
      ...
      915, 915, 915, 915, 915, 915, 915, 915, 915, 915,
      915, 915, 915, 915, 915, 915, 915, 915, 915, 915,
      915, 915, 915, 915, 915, 165,  10, 265, 180, 240,
      325,   5,   5, 225, 365,   0, 110, 395, 210, 180,
      130,  50,  95, 245,  15, 275, 420,  95, 915, 915,
      915, 915, 915, 915, 915,   0, 915,  50, 195,  15,
        0,   0,  35, 365,  55,  15,  90,   0, 135, 145,
      110,   5,  55, 320,  15,   0,  10,   5,  60, 340,
      375,  25, 110,  10, 915, 915, 915, 915, 915, 915,
      915, 915, 915, 915, 915, 915, 915, 915, 915, 915,
      915, 915, 915, 915, 915, 915, 915, 915, 915, 915,
      915, 915, 915, 915, 915, 915, 915, 915, 915, 915,
      915, 915, 915, 915, 915, 915, 915, 915, 915, 915,
...
static const unsigned char zx_attrs_lens[] =
  {
    ...
    16, 15,  6, 13,  9, 16,  2,  2,  9, 15, 11,  5,  6, 12,
     8,  9, 15,  6,  6,  7,  8,  8, 16, 12, 14, 20, 21, 22,
    15,  8, 11,  3,  4, 10,  6, 12, 13,  9,  8, 11, 12, 13,
     9, 11,  7, 18, 19, 15,  8,  9, 21,  7, 30,  6, 27, 29,
    10, 26,  6, 13, 10, 11,  6,  7, 23,  5, 11,  8,  9, 20,
     6, 13,  9, 15, 14,  6,  7,  8, 10, 12, 23,  9, 20, 12,
    15, 17, 15, 11,  9, 20, 17,  8, 10, 12,  3,  9,  5, 16,
    12,  9, 16,  7,  3,  9, 19, 16, 13,  5,  7,  9,  6,  6,
    12,  8,  4, 10, 16,  2,  5, 11, 10, 12, 10, 16,  7, 14,
     5,  3,  3,  3, 10,  6, 13, 14,  5,  7, 18, 14, 11, 15,
    16,  6,  9, 15,  6,  7, 11,  7,  9, 10, 12,  9,  5, 13,
    12,  8, 18, 10, 21, 12, 10, 10, 16,  7,  7,  8,  5,  8,
    12,  8, 12, 13, 10,  7,  8, 13, 15,  6, 18,  9,  8, 11,
    16,  4,  4, 12,  8, 12, 12, 12, 13, 10,  9, 15, 11, 12,
     8,  9, 10, 10, 12, 14, 10,  8,  8,  5,  9,  9,  9,  5,
    11, 10, 10, 15, 10,  7, 13,  8,  8,  8, 12,  9,  7,  9
  };
...
static const short lookup[] =
  {
     ...
     -443,  -305,    -3,    -1,    -1,    48,    49,
       ...
       86,    87,    -1,    -1,    -1,    -1,    88,
       -1,    89,    90,    91,    92,    93,    -1,
       94,    95,  -524,    98,    99,  -254,    -2,
      100,   101,   102,    -1,   103,    -1,   104,
      105,    -1,    -1,   106,    -1,   107,   108,
       -1,   109,   110,   111,   112,   113,   114,

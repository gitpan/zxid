/* c/zx-ps-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_ps_Object_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_Object(c, ns);
            el->g.n = &x->Object->gg.g;
            x->Object = (struct zx_ps_Object_s*)el;
            break;
          case zx_ps_Subscription_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_Subscription(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_ps_PStoSPRedirectURL_ELEM:
            ...
            el->g.n = &x->PStoSPRedirectURL->g;
            x->PStoSPRedirectURL = el;
            break;
          case zx_ps_CreatePSObject_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_CreatePSObject(c, ns);
            el->g.n = &x->CreatePSObject->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_ps_SPtoPSRedirectURL_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->SPtoPSRedirectURL->g;
            x->SPtoPSRedirectURL = el;
            break;
          case zx_ps_QueryString_ELEM:
            el = zx_DEC_simple_elem(c, ns, tok);
            el->g.n = &x->QueryString->g;
            x->QueryString = el;
            break;
...
struct zx_ps_ListMembersRequest_s* zx_DEC_ps_ListMembersRequest(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    case zx_Offset_ATTR:
      ...
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_Structured_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->Structured->g;
      x->Structured = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_id_ATTR:
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_ps_ItemData_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_ItemData(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_ps_Notification_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_Notification(c, ns);
...
struct zx_ps_Object_s* zx_DEC_ps_Object(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    tok = zx_attr_lookup(c, name, data-2, &ns);
    switch (tok) {
    case zx_CreatedDateTime_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->CreatedDateTime->g;
      x->CreatedDateTime = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_ModifiedDateTime_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->ModifiedDateTime->g;
      x->ModifiedDateTime = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_NodeType_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->NodeType->g;
      x->NodeType = ss;
      ZX_ATTR_DEC_EXT(ss);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_ps_DisplayName_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_DisplayName(c, ns);
            el->g.n = &x->DisplayName->gg.g;
            x->DisplayName = (struct zx_ps_DisplayName_s*)el;
            break;
          case zx_ps_Tag_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_Tag(c, ns);
            el->g.n = &x->Tag->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_ps_ResolveInput_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_ResolveInput(c, ns);
            el->g.n = &x->ResolveInput->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_ps_ResolveOutput_ELEM:
            el = (struct zx_elem_s*)zx_DEC_ps_ResolveOutput(c, ns);
            el->g.n = &x->ResolveOutput->gg.g;

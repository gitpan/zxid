/* c/zx-xaspcd1-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_DEC_xaspcd1_XACMLAuthzDecisionQuery) */
...
/* Called by: */
struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* zx_DEC_xaspcd1_XACMLAuthzDecisionQuery(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
  ...
  for (; c->p; ++c->p) {
    ...
    switch (tok) {
    case zx_CombinePolicies_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->CombinePolicies->g;
      x->CombinePolicies = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
...
/* FUNC(zx_DEC_xaspcd1_XACMLPolicyQuery) */
...
/* Called by: */
struct zx_xaspcd1_XACMLPolicyQuery_s* zx_DEC_xaspcd1_XACMLPolicyQuery(struct zx_ctx* c, struct zx_ns_s* ns )
{
  int tok;
  struct zx_elem_s* iternode;
  struct zx_elem_s* el;

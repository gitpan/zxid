...
struct zx_sa_Assertion_s {
  ...
  struct zx_str* Version;	/* {1,1} attribute xs:string */
};
...
/* -------------------------- sa_BaseID -------------------------- */
/* refby( zx_sa_SubjectConfirmation_s zx_sa_Subject_s zx_sp_LogoutRequest_s zx_sp_NameIDMappingRequest_s ) */
...
/* -------------------------- sa_EncryptedID -------------------------- */
/* refby( zx_sa_SubjectConfirmation_s zx_sa_Subject_s zx_sp_LogoutRequest_s zx_sp_NameIDMappingResponse_s zx_sp_NameIDMappingRequest_s zx_sp_ManageNameIDRequest_s ) */
...
/* -------------------------- sa_Issuer -------------------------- */
/* refby( zx_sp_AuthzDecisionQuery_s zx_sp_ArtifactResolve_s zx_sp_AttributeQuery_s zx_sp_ManageNameIDResponse_s zx_sp_AssertionIDRequest_s zx_sp_SubjectQuery_s zx_sp_LogoutRequest_s zx_sp_ArtifactResponse_s zx_sp_AuthnRequest_s zx_sp_NameIDMappingResponse_s zx_sp_LogoutResponse_s zx_sp_NameIDMappingRequest_s zx_sp_Response_s zx_sp_ManageNameIDRequest_s zx_sa_Assertion_s zx_sp_AuthnQuery_s ) */
...
/* -------------------------- sa_Subject -------------------------- */
/* refby( zx_sp_AuthzDecisionQuery_s zx_sp_AttributeQuery_s zx_sp_SubjectQuery_s zx_sp_AuthnRequest_s zx_sa_Assertion_s zx_sp_AuthnQuery_s ) */

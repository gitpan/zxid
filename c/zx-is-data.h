/* c/zx-is-data.h - WARNING: This header was automatically generated. DO NOT EDIT!
 * $Id$ */
...
struct zx_str* zx_is_Confirm_GET_name(struct zx_is_Confirm_s* x);
...
void zx_is_Confirm_PUT_name(struct zx_is_Confirm_s* x, struct zx_str* y);
...
struct zx_str* zx_is_Help_GET_label(struct zx_is_Help_s* x);
struct zx_str* zx_is_Help_GET_link(struct zx_is_Help_s* x);
struct zx_str* zx_is_Help_GET_moreLink(struct zx_is_Help_s* x);
void zx_is_Help_PUT_label(struct zx_is_Help_s* x, struct zx_str* y);
void zx_is_Help_PUT_link(struct zx_is_Help_s* x, struct zx_str* y);
void zx_is_Help_PUT_moreLink(struct zx_is_Help_s* x, struct zx_str* y);
...
struct zx_str* zx_is_Inquiry_GET_id(struct zx_is_Inquiry_s* x);
struct zx_str* zx_is_Inquiry_GET_title(struct zx_is_Inquiry_s* x);
...
void zx_is_Inquiry_PUT_id(struct zx_is_Inquiry_s* x, struct zx_str* y);
void zx_is_Inquiry_PUT_title(struct zx_is_Inquiry_s* x, struct zx_str* y);
...
struct zx_str* zx_is_InteractionRequest_GET_id(struct zx_is_InteractionRequest_s* x);
struct zx_str* zx_is_InteractionRequest_GET_language(struct zx_is_InteractionRequest_s* x);
struct zx_str* zx_is_InteractionRequest_GET_maxInteractTime(struct zx_is_InteractionRequest_s* x);
struct zx_str* zx_is_InteractionRequest_GET_signed_is_c_keyword(struct zx_is_InteractionRequest_s* x);
...
void zx_is_InteractionRequest_PUT_id(struct zx_is_InteractionRequest_s* x, struct zx_str* y);
void zx_is_InteractionRequest_PUT_language(struct zx_is_InteractionRequest_s* x, struct zx_str* y);
void zx_is_InteractionRequest_PUT_maxInteractTime(struct zx_is_InteractionRequest_s* x, struct zx_str* y);
void zx_is_InteractionRequest_PUT_signed_is_c_keyword(struct zx_is_InteractionRequest_s* x, struct zx_str* y);
...
struct zx_str* zx_is_Item_GET_label(struct zx_is_Item_s* x);
struct zx_str* zx_is_Item_GET_value(struct zx_is_Item_s* x);
...
void zx_is_Item_PUT_label(struct zx_is_Item_s* x, struct zx_str* y);
void zx_is_Item_PUT_value(struct zx_is_Item_s* x, struct zx_str* y);
...
struct zx_str* zx_is_Parameter_GET_name(struct zx_is_Parameter_s* x);
struct zx_str* zx_is_Parameter_GET_value(struct zx_is_Parameter_s* x);
void zx_is_Parameter_PUT_name(struct zx_is_Parameter_s* x, struct zx_str* y);
void zx_is_Parameter_PUT_value(struct zx_is_Parameter_s* x, struct zx_str* y);

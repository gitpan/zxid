/* c/zx-xasa-enc.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
/* FUNC(zx_LEN_WO_xasa_XACMLAuthzDecisionStatement) */
...
/* FUNC(zx_ENC_SO_xasa_XACMLAuthzDecisionStatement) */
...
#if 1 /* NORMALMODE */
  ZX_OUT_CLOSE_TAG(p, "</xasa:XACMLAuthzDecisionStatement>");
  zx_pop_seen(pop_seen);
#else
...
/* FUNC(zx_ENC_WO_xasa_XACMLAuthzDecisionStatement) */
...
/* FUNC(zx_EASY_ENC_SO_xasa_XACMLAuthzDecisionStatement) */
...
struct zx_str* zx_EASY_ENC_SO_xasa_XACMLAuthzDecisionStatement(struct zx_ctx* c, struct zx_xasa_XACMLAuthzDecisionStatement_s* x )
{
  ...
  return zx_easy_enc_common(c, zx_ENC_SO_xasa_XACMLAuthzDecisionStatement(c, x, buf ), buf, len);
}

/* FUNC(zx_EASY_ENC_WO_xasa_XACMLAuthzDecisionStatement) */
...
struct zx_str* zx_EASY_ENC_WO_xasa_XACMLAuthzDecisionStatement(struct zx_ctx* c, struct zx_xasa_XACMLAuthzDecisionStatement_s* x )
{
  ...
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_WO_xasa_XACMLAuthzDecisionStatement(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_WO_xasa_XACMLAuthzDecisionStatement(c, x, buf ), buf, len);
}
...
/* FUNC(zx_LEN_WO_xasa_XACMLPolicyStatement) */
...
/* FUNC(zx_ENC_SO_xasa_XACMLPolicyStatement) */
...
#if 1 /* NORMALMODE */
  ZX_OUT_CLOSE_TAG(p, "</xasa:XACMLPolicyStatement>");
  zx_pop_seen(pop_seen);
#else
  /* root node has no end tag either */
#endif
...
/* FUNC(zx_ENC_WO_xasa_XACMLPolicyStatement) */
...
/* FUNC(zx_EASY_ENC_SO_xasa_XACMLPolicyStatement) */
...
struct zx_str* zx_EASY_ENC_SO_xasa_XACMLPolicyStatement(struct zx_ctx* c, struct zx_xasa_XACMLPolicyStatement_s* x )
{
  ...
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_SO_xasa_XACMLPolicyStatement(c, x, buf ), buf, len);
}

/* FUNC(zx_EASY_ENC_WO_xasa_XACMLPolicyStatement) */
...
struct zx_str* zx_EASY_ENC_WO_xasa_XACMLPolicyStatement(struct zx_ctx* c, struct zx_xasa_XACMLPolicyStatement_s* x )
{
  ...
  c->ns_tab = ZX_ALLOC(c, sizeof(zx_ns_tab));
  memcpy(c->ns_tab, zx_ns_tab, sizeof(zx_ns_tab));
  len = zx_LEN_WO_xasa_XACMLPolicyStatement(c, x );
  buf = ZX_ALLOC(c, len+1);
  return zx_easy_enc_common(c, zx_ENC_WO_xasa_XACMLPolicyStatement(c, x, buf ), buf, len);
}

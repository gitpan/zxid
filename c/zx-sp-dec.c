/* c/zx-sp-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_sp_Status_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sp_Status(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_sp_Scoping_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sp_Scoping(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_sp_IDPEntry_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sp_IDPEntry(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_sp_NewEncryptedID_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sp_NewEncryptedID(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_sp_IDPList_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sp_IDPList(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_sp_StatusCode_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sp_StatusCode(c, ns);
          ...
          case zx_sp_StatusDetail_ELEM:
            el = (struct zx_elem_s*)zx_DEC_sp_StatusDetail(c, ns);

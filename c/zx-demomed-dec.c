/* c/zx-demomed-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_demomed_ObjectSearchParm_ELEM:
            el = (struct zx_elem_s*)zx_DEC_demomed_ObjectSearchParm(c, ns);
            el->g.n = &x->ObjectSearchParm->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_demomed_ObjectInfo_ELEM:
            el = (struct zx_elem_s*)zx_DEC_demomed_ObjectInfo(c, ns);
            el->g.n = &x->ObjectInfo->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_demomed_ObjectData_ELEM:
            el = (struct zx_elem_s*)zx_DEC_demomed_ObjectData(c, ns);
            el->g.n = &x->ObjectData->gg.g;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          case zx_demomed_Object_ELEM:
            el = (struct zx_elem_s*)zx_DEC_demomed_Object(c, ns);
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (tok) {
          ...
          case zx_demomed_ObjectStoreInfo_ELEM:
            el = (struct zx_elem_s*)zx_DEC_demomed_ObjectStoreInfo(c, ns);
            el->g.n = &x->ObjectStoreInfo->gg.g;

...
Net::WSF::WSC - Perl extension for using ID-WSF WSC
...
The above synopsis is just a tip of the iceberg. Net::WSF::WSC
is part of a bigger project called ZXID. The code for the
Net::WSF::WSC module was automagically generated from schema grammar

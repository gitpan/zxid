/* c/zx-paos-dec.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
struct zx_paos_Request_s* zx_DEC_paos_Request(struct zx_ctx* c, struct zx_ns_s* ns )
{
  ...
  for (; c->p; ++c->p) {
    ...
    switch (tok) {
    case zx_messageID_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->messageID->g;
      x->messageID = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_responseConsumerURL_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->responseConsumerURL->g;
      x->responseConsumerURL = ss;
      ZX_ATTR_DEC_EXT(ss);
      break;
    case zx_service_ATTR:
      ss = ZX_ZALLOC(c, struct zx_str);
      ss->g.n = &x->service->g;
      x->service = ss;
      ZX_ATTR_DEC_EXT(ss);

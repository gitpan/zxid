/* c/zx-dst-aux.c - WARNING: This file was automatically generated. DO NOT EDIT!
 * $Id$ */
...
{
  struct zx_dst_TestResult_s* x = ZX_ZALLOC(c, struct zx_dst_TestResult_s);
  x->gg.g.tok = zx_dst_TestResult_ELEM;
  return x;
}

#ifdef ZX_ENA_AUX

/* FUNC(zx_DUP_STRS_dst_TestResult) */
...
/* FUNC(zx_DEEP_CLONE_dst_TestResult) */
...
{
  x = (struct zx_dst_TestResult_s*)zx_clone_elem_common(c, &x->gg, sizeof(struct zx_dst_TestResult_s), dup_strs);
  /* *** deal with xmlns specifications in exc c14n way */
...
/* FUNC(zx_WALK_SO_dst_TestResult) */
...
/* FUNC(zx_WALK_WO_dst_TestResult) */
